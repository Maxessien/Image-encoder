...
const DownloadPopup = ({closePopup}: {closePopup: ()=> void}) => {
  return (
        ...
        <div className="px-6 py-2 overflow-y-auto">
          ...
          <PlatformSection title="Windows" icon={<WindowsIcon />}>
            <DownloadItem
              ...
              fileName="PixelCipher.msi"
            />
            <DownloadItem
              link="https://github.com/Maxessien/PixelCipherTauri/releases/download/v0.1.0/Pixel.Cipher_0.1.0_x64-setup.exe"
              fileName="PixelCipher.exe"
            />
          </PlatformSection>

          <PlatformSection title="macOS" icon={<AppleIcon />}>
            <DownloadItem
              link="https://github.com/Maxessien/PixelCipherTauri/releases/download/v0.1.0/Pixel.Cipher_0.1.0_aarch64.dmg"
              fileName="PixelCipher.dmg"
            />
          </PlatformSection>
          
          <PlatformSection title="Linux" icon={<LinuxIcon />}>
            <DownloadItem
              link="https://github.com/Maxessien/PixelCipherTauri/releases/download/v0.1.0/Pixel.Cipher-0.1.0-1.x86_64.rpm"
              fileName="PixelCipher.rpm"
            />
            <DownloadItem
              link="https://github.com/Maxessien/PixelCipherTauri/releases/download/v0.1.0/Pixel.Cipher_0.1.0_amd64.AppImage"
              fileName="PixelCipher.AppImage"
            />
            <DownloadItem
              link="https://github.com/Maxessien/PixelCipherTauri/releases/download/v0.1.0/Pixel.Cipher_0.1.0_amd64.deb"
              fileName="PixelCipher.deb"
            />
          </PlatformSection>
        </div>
      </motion.div>
